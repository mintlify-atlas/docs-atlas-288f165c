...
```ruby
# Activar turbo solo durante batallas
Settings::TURBO_BATTLES_ONLY = false
```

<Tip>
Útil para acelerar combates sin afectar la velocidad en el overworld.
</Tip>
...
Settings::GRAY_OUT_FAINTED_POKEMON = true
```
